...
buttonCopy.addEventListener("click", function (e) {
    ...
    if (copyField1.value == "" || copyField2.value == "" || copyField3.value == "") {
        ...
        cardCategory.setAttribute("style", "background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url(https://www.autoinforme.com.br/wp-content/uploads/2020/03/GM-tracker_2021.jpg)");
